...
def gfauto():
	...
	try:
		remove_patterns = ["","ip","sec","jsvar","php-errors","servers","upload-fields","urls","meg-headers","http-auth","debug-pages","fw","php-sinks","json-sec","s3-buckets","urls","base64"]
		for item in remove_patterns:
			gf_list.remove(item)
	except:
		pass

	pattern_with_one_process = ["ip","sec","jsvar","php-errors","servers","upload-fields","urls","meg-headers","http-auth","debug-pages","fw","php-sinks","json-sec","s3-buckets","urls","base64"]   ###Patterns that display result from all file by default
